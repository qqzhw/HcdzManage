...
namespace Hcdz.ModulePcie.Models
{
    public class FileHelper
    {
		...
		{
			if (string.IsNullOrEmpty(originalFilePath)) throw new Exception(nameof(originalFilePath));
		...
		{
			if (directoryInfo == null) throw new Exception(nameof(directoryInfo));
		...
		{
			if (string.IsNullOrEmpty(folderPath)) throw new Exception(nameof(folderPath));
		...
		{
			if (string.IsNullOrEmpty(filePath)) throw new Exception(nameof(filePath));
		...
		{
			if (fileInfo == null) throw new Exception(nameof(fileInfo));
